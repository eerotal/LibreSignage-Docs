...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/libresignage/ui/components/Dialog/PromptDialog/PromptDialog.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/libresignage/ui/components/Dialog/PromptDialog/PromptDialog.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var BaseDialog = require('libresignage/ui/components/Dialog/BaseDialog');
	...
	constructor(title, body, validators, callback) {
		...
		this.dialog.querySelector('.dialog').innerHTML += `
			&lt;div class="dialog-interaction">
				&lt;div class="dialog-input-grp">
					&lt;input class="dialog-input form-control">&lt;/input>
		...
		this.validator_trigger = new ValidatorTrigger(
			[new ValidatorSelector(
				this.dialog.querySelector(".dialog-input"),
				this.dialog.querySelector(".dialog-input-grp"),
				validators
			)],
			valid => {
				this.dialog
