...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/libresignage/ui/validator/BaseValidator/BaseValidator.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/libresignage/ui/validator/BaseValidator/BaseValidator.js</h1>
...
class BaseValidator {
	...
	*
	* @throws {AssertionError} If the settings parameter is not an object.
	* @throws {AssertionError} If the derived class hasn't overridden validate().
	*/
