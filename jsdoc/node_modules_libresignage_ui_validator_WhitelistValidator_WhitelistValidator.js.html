...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/libresignage/ui/validator/WhitelistValidator/WhitelistValidator.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/libresignage/ui/validator/WhitelistValidator/WhitelistValidator.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var BaseValidator = require('libresignage/ui/validator/BaseValidator');

/**
* @typedef {object} WhitelistValidatorSettings
*
* @property {array} wl The whitelist to use.
*
* @memberof module:libresignage/ui/validator
* @alias    WhitelistValidatorSettings
*/

/**
* Class for validating inputs against a whitelist.
*
* @memberof module:libresignage/ui/validator
*/
class WhitelistValidator extends BaseValidator {
	/**
	* Construct a new WhitelistValidator object.
	*
	* @param {WhitelistValidatorSettings} settings
	* @param {string}                     msg
	...
	*/
	...
	validate(element) {
		return this.settings.wl.includes(element.value);
	}
}
