...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/libresignage/slide/SlideAsset/SlideAsset.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/libresignage/slide/SlideAsset/SlideAsset.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var Util = require('libresignage/util/Util');
...
class SlideAsset {
	...
	*/
	constructor(slide_id, mime, filename, thumb, hash) {
		Assert.ok(slide_id != null);
		Assert.ok(mime != null);
		Assert.ok(filename != null);
		Assert.ok(thumb != null);
		Assert.ok(hash != null);
