...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/libresignage/util/Cookie/Cookie.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/libresignage/util/Cookie/Cookie.js</h1>
...
class Cookie {
	...
	*
	* @throws {AssertionError} If 'data' is not an object.
	*/
	static set(data) {
		let tmp = "";
		Assert.ok(data !== Object(data), "'data' must be an object.");
