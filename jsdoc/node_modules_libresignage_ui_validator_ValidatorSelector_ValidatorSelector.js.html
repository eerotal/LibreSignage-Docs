...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/libresignage/ui/validator/ValidatorSelector/ValidatorSelector.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/libresignage/ui/validator/ValidatorSelector/ValidatorSelector.js</h1>
...
class ValidatorSelector {
	...
	*/
	constructor(validate, style, validators, hooks) {
		Assert.ok(this.validate != null, 'No input element selected.');
	...
	*
	* @throws {AssertionError} If validator == null.
	* @throws {AssertionError} If validator is not an object.
	*/
	add(validator) {
		Assert.ok(validator != null, "Invalid null validator.");
		Assert.ok(validator === Object(validator), "Invalid validator.")
	...
	* @throws {AssertionError} If hook == null.
	*/
	add_hook(hook) {
		Assert.ok(hook != null, "Invalid null hook.");
