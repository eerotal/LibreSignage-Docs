...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/libresignage/api/APIInterface/APIInterface.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/libresignage/api/APIInterface/APIInterface.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var Cookie = require('libresignage/util/Cookie');
