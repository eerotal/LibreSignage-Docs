...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/libresignage/ui/components/Dialog/SelectDialog/SelectDialog.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/libresignage/ui/components/Dialog/SelectDialog/SelectDialog.js</h1>
	...
	*/
	constructor(title, body, options, callback) {
		...
		for (let key in options) {
			this.dialog.querySelector('.dialog-select').innerHTML += `
				&lt;option value=${key}>${options[key]}&lt;/option>
			`;
		}
		this.value = options[
			this.dialog.querySelector('.dialog-select').value
		];
