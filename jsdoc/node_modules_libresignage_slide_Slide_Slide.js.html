...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/libresignage/slide/Slide/Slide.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/libresignage/slide/Slide/Slide.js</h1>
...
var SlideAsset = require('libresignage/slide/SlideAsset');

/**
* A class representing a LibeSignage slide.
*
* @memberof module:libresignage/slide
*/
class Slide {
	/**
	...
	*
	* @throws {AssertionError} If Slide.load() hasn't been called.
	*/
	async fetch() {
		Assert.ok(this.has('id'), "Slide id not set.");
	...
	*/
	async lock_release() {
		Assert.ok(this.has('id'), "Slide not loaded.");
	...
	* Save a slide.
	*
	* @throws {AssertionError} If the slide is not locked.
	*/
	async save() {
		Assert.ok(
	...
	*
	* @throws {AssertionError} If the slide is not saved.
	* @throws {AssertionError} If the slide is not locked.
	*/
	async remove_asset(name) {
		Assert.ok(this.data.id != null, "Unsaved slide.");
		Assert.ok(this.is_locked_from_here(), "Slide not locked.");
	...
	*/
	...
	/**
	* Transpile the markup of a slide into HTML.
	*/
	transpile() {
	...
	/**
	* Get the transpiled HTML of a Slide.
	*
	* @returns {string} The HTML of the Slide.
	*/
	get_html() { return this.html; }
	...
	*/
	...
	/**
	* Get the hide animation CSS classes of a slide.
	*
	* @return {string[]} The corresponding CSS classes.
	*/
	anim_hide() {
	...
	/**
	* Get the reversed hide animation CSS classes of a slide.
	*
	* @return {string[]} The corresponding CSS classes.
	*/
	anim_hide_rev() {
	...
	/**
	* Get the show animation CSS classes of a slide.
	*
	* @return {string[]} The corresponding CSS classes.
	*/
	anim_show() {
	...
	/**
	* Get the reversed show animation CSS classes of a slide.
	*
	* @return {string[]} The corresponding CSS classes.
	*/
	anim_show_rev() {
