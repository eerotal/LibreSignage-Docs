...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/libresignage/user/User/User.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/libresignage/user/User/User.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var Quota = require('libresignage/user/Quota');
...
class User {
	...
	*/
	constructor(api) {
		Assert.ok(api != null, 'An API object must be supplied.');
		this.api = api;
		this.data = null;
	}
	...
	*/
	async create(user, passwordless) {
		this.data = {};
	...
	*
	* @throws {AssertionError} If a user is not loaded.
	*/
	async save() {
		Assert.ok(this.data != null, "User not loaded.");
		await this.api.call(
	...
	*/
	...
	/**
	* Check whether a user is passwordless.
	*
	* @return {boolean} True if the user is passwordless, false otherwise.
	*/
	is_passwordless() {
		return this.data.passwordless;
	}
