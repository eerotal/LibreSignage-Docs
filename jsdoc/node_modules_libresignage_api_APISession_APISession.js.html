...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/libresignage/api/APISession/APISession.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/libresignage/api/APISession/APISession.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var User = require('libresignage/user/User');
...
class APISession {
	...
	*/
	async logout() {
		Assert.ok(this.user !== null);
		Assert.ok(this.data !== null);
