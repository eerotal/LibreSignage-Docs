...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/libresignage/ui/validator/ValidatorTrigger/ValidatorTrigger.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/libresignage/ui/validator/ValidatorTrigger/ValidatorTrigger.js</h1>
...
class ValidatorTrigger {
	...
	*/
	...
	/**
	* Validate all ValidatorSelectors attached to a trigger.
	*/
	validate_all() {
		for (let s of this.selectors) {
			s.validate();
